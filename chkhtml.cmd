...
REM Version: 0.3 BETA (initial public release on 2019-02-08)
...
REM     or any other location in your Windows search PATH
REM Note: If you want to also see warnings, remove the "--errors-only" parameter.

REM Command line syntax:
REM    chkhtml filename.html
REM    chkhtml foldername\*.html
REM    chkhtml https://yourwebsite.tld/index.html
